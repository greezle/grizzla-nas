...
# QR sticker library: one PNG per g-code (content "M23 <SFN path>"), tree
# mirrors the long-name library. Lives in the SMB share next to master/ so
# the print-order macros link the images by stable UNC paths; regenerated by
# services/sfn.py whenever the fleet's SFN reference changes.
QR_DIR = "/srv/gcode/QR"


# a full farm SFN report is ~100 KB (1200 files); anything past this cap is
# not a plausible report
SFN_REPORT_MAX_BYTES = 2 * 1024 * 1024
